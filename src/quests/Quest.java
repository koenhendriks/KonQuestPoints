...
abstract class Quest{
    ...
    static void goToNPC(final String NPC, Area NPCArea, final String nextState){
        ...
        } else if (npcObject != null && npcObject.distance() > 4 && pathToGo != null && pathToGo.getCost() < 66){
    ...
    static void goToGameObject(final String gameObject, Area gameObjectArea, final String nextState){
        ...
        } else if (go != null && go.distance() > 4 && pathToGo != null && pathToGo.getCost() < 66){
    ...
    static void goToGroundItem(final String groundItem, Area groundItemArea, final String nextState){
        ...
        } else if (gi != null && gi.distance() > 4 && pathToGi != null && pathToGi.getCost() < 66) {
    ...
    static boolean isTalking(){
        return (clickToContinue != null && clickToContinue.isVisible()) || (clickToContinue2 != null && clickToContinue2.isVisible()) || (clickToContinue3 != null && clickToContinue3.isVisible()) || (talkOptions!= null && talkOptions.isValid());
    }
}
